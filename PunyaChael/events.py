...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import PunyaChael.events

        path = Path(f"PunyaChael/modules/{shortname}.py")
        name = "PunyaChael.modules.{}".format(shortname)
        ...
        mod.PunyaChael = PunyaChael
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["PunyaChael.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "PunyaChael/modules/*.py"
