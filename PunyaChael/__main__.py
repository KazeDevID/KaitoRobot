...
× `{}` *Uꜱᴇʀ, Aᴄʀᴏꜱꜱ* `{}` *Cʜᴀᴛꜱ.*
───────────────────────
× *Pᴏᴡᴇʀᴇᴅ Bʏ: [ KAZE ] / @KenalSayaaa *
───────────────────────"""

buttons = [
    [
        InlineKeyboardButton(text="𝑯𝒆𝒍𝒑 𝑪𝒐𝒎𝒎𝒂𝒏𝒅 ", callback_data="PunyaChael_"),
    ],
    [
...
PunyaChael_IMG = f"{START_IMG}"
PunyaChael_VIDA = f"{BOT_TUT}"
...
───────────────────""".format(
                ...
                reply_markup=InlineKeyboardMarkup(
                 [
                  [InlineKeyboardButton(text="◤𝑺𝒐𝒖𝒓𝒄𝒆 𝑪𝒐𝒅𝒆", callback_data="PunyaChael_source"), 
                   InlineKeyboardButton(text="𝑺𝒖𝒑𝒑𝒐𝒓𝒕", url=f"https://t.me/{SUPPORT_CHAT}")]
                 ]
              ),
                parse_mode=ParseMode.MARKDOWN,              
...
*Sᴇʟᴇᴄᴛ  Aʟʟ  Cᴏᴍᴍᴀɴᴅs  Fᴏʀ  Fᴜʟʟ  Hᴇʟᴘ  Oʀ  Sᴇʟᴇᴄᴛ  Cᴀᴛᴀɢᴏʀʏ  Fᴏʀ  Mᴏʀᴇ  Hᴇʟᴘ  Dᴏᴄᴜᴍᴇɴᴛᴀᴛɪᴏɴ  Oɴ  Sᴇʟᴇᴄᴛᴇᴅ  Fɪᴇʟᴅs*""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [InlineKeyboardButton(text="𝙃𝙤𝙬 𝙏𝙤 𝙐𝙨𝙚 𝙈𝙚 ", callback_data="PunyaChael_help")],
                    [InlineKeyboardButton(text=" 𝘽𝙖𝙘𝙠", callback_data="PunyaChael_back"),
                     InlineKeyboardButton(text="𝙁𝙪𝙣 𝙏𝙤𝙤𝙡𝙨", callback_data="PunyaChael_tools")],
                ]
            ),
        )
    elif query.data == "PunyaChael_back":
        first_name = update.effective_user.first_name
        uptime = get_readable_time((time.time() - StartTime))
        query.message.edit_text(
                PM_START_TEXT.format(
    ...
    elif query.data == "PunyaChael_help":
        query.message.edit_text(
...
Cʟɪᴄᴋ  Bᴇʟᴏᴡ  Bᴜᴛᴛᴏɴ  Tᴏ  Aᴅᴅ  Bᴏᴛ  Iɴ  Yᴏᴜʀ  Gʀᴏᴜᴘ. Bᴀsɪᴄ  Tᴏᴜʀ  Sᴛᴀʀᴛᴇᴅ  Tᴏ  Kɴᴏᴡ  Aʙᴏᴜᴛ  Hᴏᴡ  Tᴏ  Usᴇ  Mᴇ*""",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
              [[InlineKeyboardButton(text="𝙎𝙚𝙩𝙪𝙥 𝙏𝙪𝙩𝙤𝙧𝙞𝙖𝙡 ", callback_data="PunyaChael_vida")],
               [InlineKeyboardButton(text="➕️ 𝘼𝙙𝙙 𝙢𝙚 𝙩𝙤 𝙔𝙤𝙪𝙧 𝙂𝙧𝙤𝙪𝙥 ➕️", url=f"https://t.me/{BOT_USERNAME}?startgroup=true")],       
                [InlineKeyboardButton(text="🔙 𝘽𝙖𝙘𝙠", callback_data="PunyaChael_"),
                 InlineKeyboardButton(text="➡️", callback_data="PunyaChael_helpa")]
              ]
            ),
        )
    elif query.data == "PunyaChael_helpa":
        query.message.edit_text(
...
3). Gɪᴠɪɴɢ  Fᴜʟʟ  Pᴇʀᴍɪssɪᴏɴs  Mᴀᴋᴇ  Bot  Fᴜʟʟʏ  Usᴇғᴜʟ</b>
</b>""",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
              [[InlineKeyboardButton(text="⬅️", callback_data="PunyaChael_help"),
                InlineKeyboardButton(text="➡️", callback_data="PunyaChael_helpb")],               
              ]
            ),
        )
    elif query.data == "PunyaChael_helpb":
        query.message.edit_text(
            text="""*Cᴏɴɢʀᴀɢᴜʟᴀᴛɪᴏɴs,  Tʜɪꜱ  Bᴏᴛ  Nᴏᴡ  Rᴇᴀᴅʏ  Tᴏ  Mᴀɴᴀɢᴇ  Yᴏᴜʀ  Gʀᴏᴜᴘ

Hᴇʀᴇ  Aʀᴇ  Sᴏᴍᴇ  Essᴇɴᴛɪᴀʟᴛ  Tᴏ  Tʀʏ  Oɴ Kaze.
...
Rᴇғᴇʀ  Hᴇʟᴘ  Mᴇɴᴜ  Tᴏ  Sᴇᴇ  Eᴠᴇʀʏᴛʜɪɴɢ  Iɴ  Dᴇᴛᴀɪʟ*""",
            ...
            reply_markup=InlineKeyboardMarkup(
              [
                [InlineKeyboardButton(text="⬅️", callback_data="PunyaChael_helpa"),
                 InlineKeyboardButton(text="➡️", callback_data="PunyaChael_helpc")]
                ]
            ),
        )
    elif query.data == "PunyaChael_helpc":
        query.message.edit_text(
            text="""*× Fɪʟᴛᴇʀs
...
Sᴇɴᴅ  /chatbot  Oɴ  Aɴᴅ  Rᴇᴘʟʏ  Tᴏ  Aɴʏ  Oғ  Mʏ  Mᴇssᴀɢᴇs  Tᴏ  Sᴇᴇ  Tʜᴇ  Mᴀɢɪᴄ*""",
            ...
            reply_markup=InlineKeyboardMarkup(
              [
                [InlineKeyboardButton(text="⬅️", callback_data="PunyaChael_helpb"),
                 InlineKeyboardButton(text="➡️", callback_data="PunyaChael_helpd")]
                ]
            ),
        )
    elif query.data == "PunyaChael_helpd":
        query.message.edit_text(
...
ᴀɴᴅ  ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ  ᴏᴘᴇɴɴᴇᴅ  ᴀᴛ  6ᴀᴍ(ɪsᴛ)  ᴛᴏ  ᴘʀᴇᴠᴇɴᴛ  ɴɪɢʜᴛ  sᴘᴀᴍs.*""",
            ...
            reply_markup=InlineKeyboardMarkup(
              [
                [InlineKeyboardButton(text="⬅️", callback_data="PunyaChael_helpc"),
                 InlineKeyboardButton(text="➡️", callback_data="PunyaChael_helpe")]
                ]
            ),
        )
    elif query.data =="PunyaChael_term":
        query.message.edit_text(
...
- Its coded by @KenalSayaaa .so any quire contact me
...
*Support Chat:* @{SUPPORT_CHAT}""",
    ...
    elif query.data == "PunyaChael_helpe":
        query.message.edit_text(
...
× Bʏ  Usɪɴɢ  Tʜɪꜱ  Bᴏᴛ  Yᴏᴜ  Aʀᴇ  Aɢʀᴇᴇᴅ  Tᴏ  Oᴜʀ  Tᴇʀᴍs  &  Cᴏɴᴅɪᴛɪᴏɴs*""",
            ...
            reply_markup=InlineKeyboardMarkup(
                ...
                [InlineKeyboardButton(text="⬅️", callback_data="PunyaChael_helpd"),
                InlineKeyboardButton(text="𝙈𝙖𝙞𝙣 𝙈𝙚𝙣𝙪", callback_data="PunyaChael_")]]
            ),
        )
    elif query.data == "PunyaChael_music":
        query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
               [[InlineKeyboardButton(text="𝙎𝙚𝙩𝙪𝙥 𝙏𝙪𝙩𝙤𝙧𝙞𝙖𝙡 🎥", callback_data="PunyaChael_vidb")],
                [InlineKeyboardButton(text="𝙋𝙡𝙖𝙮 𝘾𝙤𝙢𝙢𝙖𝙣𝙙𝙨", callback_data="PunyaChael_musica"),
                 InlineKeyboardButton(text="𝘽𝙤𝙩 𝘾𝙤𝙢𝙢𝙖𝙣𝙙𝙨", callback_data="PunyaChael_musicc")],
                [InlineKeyboardButton(text="𝘼𝙙𝙢𝙞𝙣 𝘾𝙤𝙢𝙢𝙖𝙣𝙙𝙨", callback_data="PunyaChael_musicb"),
                 InlineKeyboardButton(text="𝙀𝙭𝙩𝙧𝙖 𝘾𝙤𝙢𝙢𝙖𝙣𝙙𝙨", callback_data="PunyaChael_musicd")],
                [InlineKeyboardButton(text="🔙 𝘽𝙖𝙘𝙠", callback_data="PunyaChael_")]
               ]
            ),
        )
    elif query.data == "PunyaChael_musica":
        query.message.edit_text(
            text="""✗*Here is the help for Play Commands*:

*Note*: @StreamMusikBot  works on a single merged commands for Music and Video
...
✗ *Bot Database Saved Playlists*:

/createplaylist
- Create Your Playlist on Robot Server with Custom Name
...
/playplaylist 
- Start playing Your Saved Playlist on PunyaChael Servers.""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="🔙 𝘽𝙖𝙘𝙠", callback_data="PunyaChael_music")]]
            ),
        )
    elif query.data == "PunyaChael_musicb":
        query.message.edit_text(
...
PunyaChael has a additional feature for non-admin users who want to use admin commands
...
- Check AUTH LIST of the group.""",
    ...
    elif query.data == "PunyaChael_musicc":
        query.message.edit_text(
...
/ping
- Ping the Bot and check Ram, Cpu etc stats of KAZE.""",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="🔙 𝘽𝙖𝙘𝙠", callback_data="PunyaChael_music")]]
            ),
        )
    elif query.data == "PunyaChael_musicd":
        query.message.edit_text(
...
- Download any track from youtube in mp3 or mp4 formats via Nobita.
...
- When enabled, Tiana will be deleting her 3rd last message to keep your chat clean.""",
    ...
    elif query.data == "PunyaChael_about":
        query.message.edit_text(
            text=f"""{BOT_NAME} it's online since 19/04/2022 and it's constantly updated!
            
Bot Admins
                       
• @{OWNER_USERNAME}, bot creator .

• [Lord-Kaze](https://t.me/KenalSayaaa) The Doctor, Coder , server manager and developer.
...
• We also thank all the groups who rely on our Bot for this service, we hope you will always like it: we are constantly working to improve it!""",
    ...
    elif query.data == "PunyaChael_support":
        query.message.edit_text(
    ...
    elif query.data == "PunyaChael_tools":
        query.message.edit_text(
            text="""*Here is the help for the tools module:
We promise to keep you latest up-date with the latest technology on telegram. 
we updradge PunyaChael everyday to simplifie use of telegram and give a better exprince to users.
...
Click on below buttons and check amazing tools for users.*""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Sᴇᴀʀᴄʜ", callback_data="PunyaChael_toola"),
                    InlineKeyboardButton(text="Tᴀɢᴀʟʟ", callback_data="PunyaChael_toolb"),
                    InlineKeyboardButton(text="Kᴀʀᴍᴀ", callback_data="PunyaChael_toolc"),
                 ],
                 [
                    InlineKeyboardButton(text="Fᴏɴᴛ Gᴇɴ", callback_data="PunyaChael_toold"),
                    InlineKeyboardButton(text="Pᴀꜱᴛᴇ", callback_data="PunyaChael_toole"),
                    InlineKeyboardButton(text="Tᴇʟᴇɢʀᴀᴘʜ", callback_data="PunyaChael_toolf"),
                 ],
                 [
                    InlineKeyboardButton(text="🔙 𝘽𝙖𝙘𝙠", callback_data="PunyaChael_"),
    ...
    elif query.data == "PunyaChael_toola":
        query.message.edit_text(
            text="""「 Hᴇʟᴘ ᴏғ Sᴇᴀʀᴄʜ 」:
 ...
 ❍ /reverse: Does a reverse image search of the media which it was replied to.""",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="🔙 𝘽𝙖𝙘𝙠", callback_data="PunyaChael_tools")]]
            ),
        )
    elif query.data == "PunyaChael_toolb":
        query.message.edit_text(
            text="""「 Hᴇʟᴘ ᴏғ Tᴀɢᴀʟʟ 」:
...
Note- Only admins can Use Tagall Command.""",
    ...
    elif query.data == "PunyaChael_toolc":
        query.message.edit_text(
            text="""「 Hᴇʟᴘ ᴏғ Kᴀʀᴍᴀ 」:
...
- /karma: Chek karma list of top 10 users""",
    ...
    elif query.data == "PunyaChael_toold":
        query.message.edit_text(
 ...
 - /lined text: lined your text!""",
    ...
    elif query.data == "PunyaChael_toole":
        query.message.edit_text(
            text="""「 Hᴇʟᴘ ᴏғ Pᴀꜱᴛᴇ 」:
 ...
 ❍ /paste: Saves replied content to replies with a url""",
    ...
    elif query.data == "PunyaChael_toolf":
        query.message.edit_text(
 ...
 ❍ /txt :Get Telegraph Link of Replied Text""",
    ...
    elif query.data == "PunyaChael_source":
        query.message.edit_text(
            text="""*Kaze is Now Open Source Bot Project.*
...
*Click below Button to Get Source Code.*""",
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="◤𝑺𝒐𝒖𝒓𝒄𝒆 𝑪𝒐𝒅𝒆", url="github.com/PunyaChael/KaitoRobot"),
                 ]
                ]
            ),
        )
    elif query.data == "PunyaChael_vida":
        query.message.reply_video(
            PunyaChael_VIDA,
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,           
        )
    elif query.data == "PunyaChael_vidb":
        query.message.reply_video(
            PunyaChael_VIDB,
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,           
...
@run_async
def PunyaChael_about_callback(update: Update, context: CallbackContext):
    query = update.callback_query
    if query.data == "about_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
               [
                 [
                     InlineKeyboardButton(text="𝑰𝒏𝒇𝒐", callback_data="PunyaChael_about"),
                     InlineKeyboardButton(text="◤𝑺𝒐𝒖𝒓𝒄𝒆 𝑪𝒐𝒅𝒆", callback_data="PunyaChael_source"),
                 ],
                 [  
                    InlineKeyboardButton(text="𝑺𝒖𝒑𝒑𝒐𝒓𝒕", callback_data="PunyaChael_support"),
                    InlineKeyboardButton(text="𝑶𝒘𝒏𝒆𝒓", url=f"t.me/{OWNER_USERNAME}"),
                 ],
                 [
                     InlineKeyboardButton(text="🕊.⋆𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓", url=f"t.me/KenalSayaaa"),
                 ],
                 [
...
def get_help(update: Update, context: CallbackContext):
    ...
    if chat.type != chat.PRIVATE:
        ...
        send_help(
            ...
            text,
            InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Back", callback_data="PunyaChael_")]]
            ),
        )
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "𝙆𝘼𝙕𝙀 𝙐𝙥𝙙𝙖𝙩𝙚𝙙 𝙎𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡𝙮✅")
        except Unauthorized:
            LOGGER.warning(
    ...
    about_callback_handler = CallbackQueryHandler(tiana_callback_handler, pattern=r"PunyaChael_")
    PunyaChael_callback_handler = CallbackQueryHandler(PunyaChael_about_callback, pattern=r"about_")
    ...
    dispatcher.add_handler(PunyaChael_callback_handler)
