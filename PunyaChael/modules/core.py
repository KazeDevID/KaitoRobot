...
from PunyaChael.events import load_module
import asyncio
import os
from datetime import datetime
        ...
        try:
            downloaded_file_name = (
                await event.client.download_media(  # pylint:disable=E0602
                    ...
                    "PunyaChael/modules/",  # pylint:disable=E0602
                )
            )
...
from PunyaChael import telethn as tbot, OWNER_ID, DEV_USERS
from PunyaChael.events import register
import os
import asyncio
import os
